"""
Django settings for lully_test_app_45253 project.
...
ROOT_URLCONF = 'lully_test_app_45253.urls'
...
WSGI_APPLICATION = 'lully_test_app_45253.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lully_test_app_45253 API",
    "DESCRIPTION": "API documentation for lully_test_app_45253 App",
    "VERSION": "v1",
}
